import { Response, Body, Controller, HttpException, HttpStatus, Param, Post, UploadedFile, UseGuards, UseInterceptors } from '@nestjs/common';
...
import { ExamAutoGenerateDto, ExamEndDto } from './dto';
